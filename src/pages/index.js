      ...
      <div style={introStyle}>
        <Container>
          <div className="intro-text mx-auto py-5">
            ...
            <p>
              Hello! This is a personal website to showcase my projects and
              work.
            </p>
      ...
      <Container>
        <Row className="text-center my-3">
          <Col sm={6} className="py-3">
            <Button href="/webdev" style={btnStyle} variant="info">
              Web Dev
            </Button>
            <Slideshow data={webPrev} />
          </Col>
          <Col sm={6} className="py-3">
            <Button href="/gamedev" style={btnStyle} variant="info">
              Game Dev
            </Button>
